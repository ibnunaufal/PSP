package id.co.solusinegeri.sms_gateway.ui.customprogressdialog
...
import kotlinx.android.synthetic.main.custome_preloaded.view.*
...
class CustomProgressDialog {
    ...
    fun show(context: Context, title: CharSequence?): Dialog {
        ...
        val view = inflater.inflate(R.layout.custome_preloaded, null)
        if (title != null) {
